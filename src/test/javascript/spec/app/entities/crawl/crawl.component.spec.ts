...
import { CrawlComponent } from 'app/entities/crawl/crawl.component';
import { CrawlService } from 'app/entities/crawl/crawl.service';
import { Crawl } from 'app/shared/model/crawl.model';

describe('Component Tests', () => {
  describe('Crawl Management Component', () => {
    let comp: CrawlComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CrawlComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.crawls && comp.crawls[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
